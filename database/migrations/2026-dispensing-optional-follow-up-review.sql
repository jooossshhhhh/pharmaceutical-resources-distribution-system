/*
=====================================================
MIGRATION: Dispensing Optional Follow-up in Review

Keeps partial release metadata optional. If staff select
a follow-up action, the action-specific fields are still
validated before stock is released.
=====================================================
*/
