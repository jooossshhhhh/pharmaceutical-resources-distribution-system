...
import { MIN_PASSWORD_LENGTH } from "@shared/utils/authRegistrationUtils";
        ...
        {state.step === "choose" ? (
          ...
          <div className="mt-6 grid gap-4">
            <p className="text-xs font-medium normal-case tracking-normal text-slate-500">
              Use at least {MIN_PASSWORD_LENGTH} characters. Passphrases are accepted.
            </p>
            <ModalField
...
function PasswordField({ isVisible, label, minLength, onChange, onToggle, value }) {
  return (
