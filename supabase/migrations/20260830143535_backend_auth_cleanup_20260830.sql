...
-- The current frontend uses get_stock_transfer_allocation_batches().
-- This compatibility wrapper bypassed its own checks and is no longer part of the app API.
...
-- FK indexes for high-use workflow joins and filters.
